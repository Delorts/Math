let arTrian=(altura,base)=>{
    let arTriangulo=base*altura/2;
...
let arCir=(radio)=>{
    let arCirculo=Math.PI*(Math.pow(radio,2));
...
let arRect=(base,altura)=>{
    let arRectangulo=base*altura;
